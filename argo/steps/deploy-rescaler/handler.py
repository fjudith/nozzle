...
parser.add_argument('-f', '--filename', help="JSON file that contains list ingress namespaces")
parser.add_argument('-o', '--output', help="JSON output file that contains list of deployed rescaler", default=os.environ.get('JSON_OUTPUT', default="/tmp/rescale-deployments.json"))
